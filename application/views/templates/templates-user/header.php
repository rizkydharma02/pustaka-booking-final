...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand">Pustaka Dharma</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a href="<?= base_url() ?>" class="nav-item nav-link active">Beranda <span
          ...
          <a href="<?= base_url('member/logout'); ?>" class="nav-item nav-link"
            onclick="return confirm('Yakin ingin Log out?')"><i class="fas fw fa-login"></i> Log out</a>
          <?php } else { ?>
          <a href="#" data-toggle="modal" data-target="#daftarModal" class="nav-item nav-link"><i
              class="fas fw fa-login"></i> Daftar</a>
          <a href="#" data-toggle="modal" data-target="#loginModal" class="nav-item nav-link"><i
